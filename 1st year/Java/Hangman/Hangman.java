...
public class Hangman implements Serializable{
    public static void main(String[] args) {
        ...
        for (String i : load()){
            words.add(new String(i));
        }
        /*List<String> words = Arrays.asList(load();
            // A
        ...
        while(true){
            ...
            word = preparation.wordlist(words);
            clearScreen();
            game(word, sc);
        }
        sc.close();
    }
    public static String Menu(Scanner sc, String m, List<String> words){
        //shows menu
        String output = "";
        do{
            clearScreen();
            ...
            System.out.println("                ╚══════════════════╝\u001B[0m");
            System.out.println("\u001B[38;2;230;57;70m                ╔══════════════════╗");
            System.out.println("                ║     Exit (e)     ║");
            System.out.println("                ╚══════════════════╝\u001B[0m");
            //looks for the input
            System.out.println("\n\u001B[38;2;230;57;70m Please don't enter 'e'!!!! \u001B[0m");
    ...
    public static void addWord(List<String> words, Scanner sc, String m){
        clearScreen();
        ...
        while (!m.equals("b")) {
            ...
            System.out.println("If you want to go back, type and enter 'b'.\n");
    ...
    public static void game(String word, Scanner sc){
        ...
        System.out.printf("\n\n\nTime played: %d s%nAmount of guesses: %d%nAmount of wrong guesses: %d%n", time, guess.size(), failedguess);
        System.out.println("\n\u001B[38;2;230;57;70mPlease wait and don't press anything till the menu comes!\u001B[0m");
        try {
    ...
    private static List<String> load() {
        List<String> words = new ArrayList<>();
        try {
            FileInputStream fis = new FileInputStream("words.csv");
            ObjectInputStream ois = new ObjectInputStream(fis);

            words = (List) ois.readObject();
            ois.close();
            fis.close();
        } catch (IOException ioe) {
            ioe.printStackTrace();
...
class preparation{
    public static String wordlist(List<String> words) {
